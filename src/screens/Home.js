    ...
    <>
      ...
      <div className="new__addons__container">
        ...
        <div className="new__addons__container__overlay">
          <div className="new__addons__container__heading">VALUE ADD-ONS</div>
          <div className="new__addons__container__content">
            ...
            <AddonsCard
              img={apiSvg}
              hoverImg={apiSvg}
              text="Integration with existing HIMS using API &SDK"
            />
            <AddonsCard
              img={patientSaftySvg}
              hoverImg={patientSaftySvg}
              text="Improved patient safety with Early Warning System"
            />
          </div>
        </div>
      </div>
